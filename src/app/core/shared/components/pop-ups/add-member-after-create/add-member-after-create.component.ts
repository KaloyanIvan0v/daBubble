...
@Component({
  selector: 'app-add-member-after-create',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './add-member-after-create.component.html',
  styleUrl: './add-member-after-create.component.scss',
})
export class AddMemberAfterCreateComponent implements OnDestroy {
   ...
   */
  get popUpVisible() {
    return this.workspaceService.addUserAfterCreateChannelPopUp();
  }
   ...
   */
  closePopUp() {
    this.workspaceService.addUserAfterCreateChannelPopUp.set(false);
  }
